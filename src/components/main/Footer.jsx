...
function Footer() {
  ...
  const footerLinks = [
    ...
    { url: "https://data.seoul.go.kr/", img: "/img/footer/ftlogo_seoulopendata.png", alt: "seoulopendata" },
    { url: "https://www.culture.go.kr/data/main/main.do", img: "/img/footer/ftlogo_culturedata.png", alt: "문화공공데이터광장" },
    { url: "https://www.durunubi.kr/", img: "/img/footer/ftlogo_durunubi.jpg", alt: "durunubi" },
    ...
    <div className="Footer">
      <div className="slide-container">
        <ul
          ...
          style={{ animationPlayState: animate ? "" : "stop" }}
          onMouseEnter={onStop}
          onMouseLeave={onRun}
        >
